...
def list_files(path, sigma):
    try:
        ...
        return [
            ...
            and fnmatch.fnmatch(f, f"*_sigma_{sigma}_*.json")
        ]
...
if __name__ == "__main__":
    ...
    for sigma in sigmas:
        file_model = list_files(model_path, sigma)[0]
        print(file_model)
