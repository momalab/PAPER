...
def list_files(path, sigma, nmodels):
    try:
        ...
        return [
            ...
            and fnmatch.fnmatch(f, f"*_sigma_{sigma}_*_models_{nmodels}.json")
        ]
...
if __name__ == "__main__":
    ...
    for e in ensembles:
        for s in sigmas:
            # print
            print(f"Running experiment with ensemble={e}, sigma={s}")

            # list files
            filenames = list_files(model_path, s, e)
